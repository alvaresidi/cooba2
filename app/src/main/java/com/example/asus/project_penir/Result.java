...
public class Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(stats.equals("finish")){

            txtnama.setText("Congratulations " +nama + " ! you finish this game.");
            txtscore.setText("Your final score is " + skor + "!");

        }
        else if(stats.equals("fail")){

            txtnama.setText("don't give up " +nama + " ! you finish this game.");
            txtscore.setText("Your final score is " + skor + " ! you fcking noob");
