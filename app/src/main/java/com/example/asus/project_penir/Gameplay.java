...
public class Gameplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //looping untuk munculkan jumlah btn jwban dan beri event
        for (int i=0; i<idButtonhasil.length; i++) {
            final int b = i;
             // Fetch the view id from array
            //event
                    ...
                    if(btJawab[b].getText().toString().equals("")){
                        ...
                        if(numberfix<urutanJawaban){
                            ...
                            if(lengthJawaban==urutanJawaban){
                                ...
                                jawabanUser = xx;
                                //harus equals KALO STRING gk boleh == basic java! :)
                                ...
                                else if (jawabanUser.equals(jawaban)&&jenislevel.equals("medium")){
                                    Toast.makeText(getApplicationContext(),  "jawaban benar" , Toast.LENGTH_SHORT).show();
                                    skor += 75;
                                    urutanSoal ++;
                                    ronde++;
    ...
    public void SetIDButton(){
        //karena buton jawaban pasti jumlahnya lgsg diset text disini
        for (int i=0; i<idArrayButton.length; i++) {
            final int b = i;
            btJawab[b] = (Button) findViewById(idArrayButton[b]); // Fetch the view id from array
            textBtn = String.valueOf(soal.charAt(b));
            btJawab[b].setText(textBtn);
        }
        ...
        for (int i=0; i<lengthJawaban; i++) {
            final int b = i;
            btHasil[b].setVisibility(View.VISIBLE); // Fetch the view id from array
        }
    ...
    public void RefreshJawaban(){
        for (int i=0; i<lengthJawaban; i++) {
            final int b = i;
            btHasil[b].setText(""); // Fetch the view id from array
        }
